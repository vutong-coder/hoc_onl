  ...
  const fetchCourseData = async () => {
    ...
    try {
      ...
      try {
        ...
        // nếu API quiz chưa sẵn sàng, bỏ qua
              ...
              <div style={{
                ...
                <p style={{ color: 'var(--muted-foreground)', marginBottom: 'var(--space-6)' }}>
                  {quizScore >= (quiz.passingScore || 0) 
                    ...
                    : `Bạn cần đạt tối thiểu ${quiz.passingScore}% để hoàn thành bài quiz.`
                  }
                </p>
                {quizSubmitError && (
                  <div style={{
          ...
          <div className="material-info-section">
            ...
            {currentMaterial.type === 'quiz' && !isMaterialCompleted(currentMaterial.id) && (
              <div className="quiz-completion-hint">
                <AlertCircle />
                <span>Hoàn thành bài quiz bằng cách nộp bài. Nút hoàn thành sẽ tự cập nhật sau khi nộp.</span>
              </div>
            )}
