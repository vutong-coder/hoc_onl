	...
	return (
		<div className="space-y-3" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
			...
			<button
				...
				className="flex items-center justify-center space-x-2 px-3 py-3 border border-[var(--border)] rounded-lg hover:bg-[var(--muted)] transition-all duration-300 hover:scale-105 active:scale-95"
				style={{
					display: 'flex',
					alignItems: 'center',
					justifyContent: 'center',
